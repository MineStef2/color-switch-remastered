...
public class FadingButton extends Button{
	...
	private float minOpacity, maxOpacity, fadeSpeed, secondaryFadeSpeed;

	public FadingButton(Texture texture, Vector2 position, Vector2 scale, Screen owner, float minOpacity, float maxOpacity, float fadeSpeed, float secondaryFadeSpeed) {
	...
	public FadingButton(Texture texture, Vector2 position, Screen owner, float minOpacity, float maxOpacity, float fadeSpeed, float secondaryFadeSpeed) {
		this(texture, position, new Vector2(1f, 1f), owner, minOpacity, maxOpacity, fadeSpeed, secondaryFadeSpeed);
	}

	public FadingButton(Texture texture, Screen owner, float minOpacity, float maxOpacity, float fadeSpeed, float secondaryFadeSpeed) {
		this(texture, new Vector2(0, 0), new Vector2(1f, 1f), owner, minOpacity, maxOpacity, fadeSpeed, secondaryFadeSpeed);
	}
	...
	public FadingButton(Texture texture, Vector2 position, Screen owner, float minOpacity, float maxOpacity, float fadeSpeed) {
		this(texture, position, owner, minOpacity, maxOpacity, fadeSpeed, 0);
	}

	public FadingButton(Texture texture, Vector2 position, Vector2 scale, Screen owner, float minOpacity, float maxOpacity, float fadeSpeed) {
