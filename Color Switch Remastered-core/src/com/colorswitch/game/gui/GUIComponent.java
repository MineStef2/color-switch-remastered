...
public class GUIComponent extends Sprite implements DrawCall{
	...
	public GUIComponent flipXCoordinate() {
		...
		ColorSwitch.getInstance();
		this.setPosition(this.flippedX ? ColorSwitch.getInstance().getConfig().width - this.getWidth() : this.getX() - ColorSwitch.getInstance().getConfig().width + this.getWidth(), this.getY());
		return this;
	}
	...
	public GUIComponent flipYCoordinate() {
		...
		ColorSwitch.getInstance();
		ColorSwitch.getInstance();
		this.setPosition(this.getX(), this.flippedY ? ColorSwitch.getInstance().getConfig().height - this.getHeight() : this.getY() - ColorSwitch.getInstance().getConfig().height + this.getHeight());
		return this;
	}
